...
private:
	...
	void ProcessLeaveRoom(UINT32 clinetIndex_, UINT16 packetSize_, char* pPacket_);
	void ProcessRoomChatMessage(UINT32 clinetIndex_, UINT16 packetSize_, char* pPacket_);
...
private:
	...
	std::function<void(int, char*)> mSendMQDatraFunc;
